...
function Model(props) {
  ...
  //changes the material of the 3d model ie color of the iphone
  useEffect(() => {
    Object.entries(materials).map((material) => {
      // these are the material names that can't be changed color
      if (
        material[0] !== "zFdeDaGNRwzccye" &&  //material[0] is the material's name.
        material[0] !== "ujsvqBWRMnqdwPx" &&
        material[0] !== "hUlRcbieVuIiOXG" &&
        material[0] !== "jlzuBkUzuJqgiAK" &&
        material[0] !== "xNrofRCqOXXHVZt"
      ) {
        material[1].color = new THREE.Color(props.item.color[0]);  //material[1] is the material's properties (e.g., color, texture).
      }
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        scale={0.01}
      >
        <meshStandardMaterial roughness={1} map={texture} />  {/*apply the texture n color properly */}
      </mesh>
      <mesh
        castShadow
        receiveShadow
